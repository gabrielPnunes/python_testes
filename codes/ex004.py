...
print('A letra A aparece pela primeira vez na posição {} da frase'.format(fra.find('a')+1))
print('A letra A aparece pela última vez na posição {} da frase'.format(fra.rfind('a')+1))

sobr_nam = str(input('Digite seu nome completo: ')).strip()
...
print('O último nome é {}'.format(ult_nam[len(ult_nam)-1]))